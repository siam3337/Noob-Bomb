...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : MD Siam Ehosun Sun\033[94m│".center(columns+15))

    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))

    print("│ \033[95mGitHub : https://github.com/Noob-Bomb \033[94m│".center(columns+9))

    print("│ \033[95mCoder  : Toxic Team          \033[37mV4.1 \033[94m│".center(columns+15))
